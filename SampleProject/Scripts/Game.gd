...
func save_game():
	...
	save_manager.set_value("quick_relics", EquipMenu.serializeQuickRelics())
...
func load_game():
	...
	EquipMenu.deserializeQuickRelics(save_manager.get_value("quick_relics"))
