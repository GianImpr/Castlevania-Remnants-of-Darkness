...
- If you instead want to open the project in Godot, you can download the source code and then open ```project.godot``` in Godot Engine 4.6.
...
> [!WARNING]
> When opening this project, **please use Godot Engine 4.6**, as the project is not compatible with older versions of the engine.
